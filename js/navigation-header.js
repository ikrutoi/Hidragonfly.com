    ...
    headerNavButton.forEach((el) => {
        ...
        function showMainNav() {
            const selectedElem = document.querySelector(
                `.main-nav-menu--${datasetElement}`
            );

            if (
                ((datasetElement == 'aroma' || datasetElement == 'date') &&
                    selectedElem.classList.contains('selected')) ||
        ...
        function addBorderBottom() {
            ...
            const targetMainButton = document.querySelector(
                `.main-nav-menu--${datasetElement}`
            );

            if (
                (targetMainButton &&
                    targetMainButton.classList.contains('selected')) ||
                el.classList.contains('header-nav--button-cardphoto')
            ) {
            ...
            switch (datasetElement) {
                case 'cardphoto':
                    const cardphotoImage =
                        document.querySelector('.cardphoto-image');
                    const cardphotoForm =
                        document.querySelector('.cardphoto-form');
                    ...
                    cardphotoForm.style.width =
                        window.getComputedStyle(cardphotoImage).width;
                    cardphotoForm.style.height =
                        window.getComputedStyle(cardphotoImage).height;
                ...
                case 'aroma':
                    if (
                        document.querySelector(`.${datasetElement}-block`)
